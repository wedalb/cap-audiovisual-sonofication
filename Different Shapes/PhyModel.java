...
public class PhyModel extends PhyObject {
    ...
    public ArrayList<PhyModel> m_subModels = new ArrayList<>();
    public ArrayList<Mass> m_masses = new ArrayList<>();
    public ArrayList<InOut> m_inOuts = new ArrayList<>();
    public ArrayList<Interaction> m_interactions = new ArrayList<>();
